...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rss_subscription', (
        ...
        db.send_create_signal('rss', ['Subscription'])

        # Adding model 'SubscriptionItem'
        db.create_table('rss_subscriptionitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('rss', ['SubscriptionItem'])


    def backwards(self, orm):
        # Deleting model 'Subscription'
        db.delete_table('rss_subscription')

        # Deleting model 'SubscriptionItem'
        db.delete_table('rss_subscriptionitem')
