...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionItem.title'
        db.add_column('rss_subscriptionitem', 'title',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionItem.title'
        db.delete_column('rss_subscriptionitem', 'title')
