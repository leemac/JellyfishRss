...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionItem.thumbnail_url'
        db.add_column(u'rss_subscriptionitem', 'thumbnail_url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionItem.thumbnail_url'
        db.delete_column(u'rss_subscriptionitem', 'thumbnail_url')
