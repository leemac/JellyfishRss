...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscriptionItem.thumbnail_processed'
        db.add_column(u'rss_subscriptionitem', 'thumbnail_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscriptionItem.thumbnail_processed'
        db.delete_column(u'rss_subscriptionitem', 'thumbnail_processed')
    ...
    models = {
        ...
        u'rss.subscriptionitem': {
            ...
            'thumbnail_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'thumbnail_url': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'title': ('django.db.models.fields.TextField', [], {}),
            'url': ('django.db.models.fields.TextField', [], {})
        },
